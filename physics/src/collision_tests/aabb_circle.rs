...
mod tests {
    ...
    proptest! {
        ...
        fn test_overlaps_edges(
            ...
            circle_dist_percent in 0.1..=0.99f64,
        ) {
            ...
            let centers = [
                V2::new(x + width + circle_width_dist, y + height * height_percent),
                V2::new(x - width - circle_width_dist, y + height * height_percent),
        V2::new(x + width * width_percent, y + height + circle_height_dist),
        V2::new(x - width * width_percent, y - height - circle_height_dist),
            ];
            ...
            for center in centers.iter().cloned() {
                ...
                prop_assert!(aabb_circle_test(&aabb, &circle), "{:?} {:?}", aabb, circle);
            }
        }
    }
}
